...
EXPORT void set_swarm_params(AgentEngineAVX2* engine, double kappa, double R_c, double K_phi, double mismatch_rate, double residue_decay) {
    engine->setParams(kappa, R_c, K_phi, mismatch_rate, residue_decay);
}
...
EXPORT void get_swarm_metrics(AgentEngineAVX2* engine, double* x_mean, double* x_rms, double* order_param, double* residue_mean) {
