...
def run(root, output, focus=None):
    ...
    report["delta"]["resolved_obligations"] = [{"obligation_id":"malformed_construction_rules","resolution":"FORMALIZED"}]
