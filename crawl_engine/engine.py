...
DISPOSED_RELATION_AXIOMS = RELATION_AXIOMS[:7]
OPEN_RELATION_AXIOMS = RELATION_AXIOMS[7:]
...
def run(root, output, focus=None):
    ...
    report["delta"]["resolved_obligations"] = [{"obligation_id":"determinism_validation_layers","resolution":"PARTIALLY_ESTABLISHED"}]
    report["delta"]["new_open_obligations"] = ["OBL-R08-CANONICAL-PROJECTION-SELECTION"]
    report["delta"]["added_axiom_dispositions"] = [{"axiom_id":"AX-R08_DETERMINISM","status":"PARTIALLY_RESOLVED_BLOCKED"}]
