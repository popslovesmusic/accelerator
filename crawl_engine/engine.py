...
def run(root, output, focus=None):
    ...
    report["object_inventory"]["unresolved"] = [{"object_id": "OBL-RT-IDENTITY-WHOLE", "reason": "open whole-RT identity obligation"}, {"object_id": "OBL-R04-TYPED-EQUIVALENCE", "reason": "open typed equivalence obligation"}, {"object_id": "OBL-R04-CONGRUENCE", "reason": "blocked congruence obligation"}] + [{"object_id": axiom, "reason": "open axiom obligation"} for axiom in OPEN_RELATION_AXIOMS]
    ...
    report["delta"]["new_blockers"] = ["BLOCK-SUBSTITUTION-EQUIVALENCE"]
