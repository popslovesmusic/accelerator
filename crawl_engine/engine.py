...
def run(root, output, focus=None):
    ...
    report["object_inventory"]["unresolved"] = [{"object_id": "OBL-RT-IDENTITY-WHOLE", "reason": "open whole-RT identity obligation"}, {"object_id": "OBL-R04-TYPED-EQUIVALENCE", "reason": "unblocked pending equivalence definition"}, {"object_id": "OBL-R04-CONGRUENCE", "reason": "blocked by unresolved typed equivalence"}] + [{"object_id": axiom, "reason": "open axiom obligation"} for axiom in OPEN_RELATION_AXIOMS]
    report["object_inventory"]["counts"]["unresolved"] = len(OPEN_RELATION_AXIOMS) + 3
    report["proof_state"]["open_obligations"] = ["OBL-RT-IDENTITY-WHOLE", "OBL-R04-TYPED-EQUIVALENCE", "OBL-R04-CONGRUENCE"] + OPEN_RELATION_AXIOMS
    ...
    report["blockers"].insert(0, {"blocker_id":"BLOCK-SUBSTITUTION-EQUIVALENCE","blocker_type":"MISSING_DEFINITION","subject_object_id":"symmetry_condition_relation","description":"General substitution is blocked because typed operand distinction semantics do not yet define an equivalence relation or relation congruence.","direct_or_propagated":"DIRECT","blocking_dependencies":["OBL-R04-CONGRUENCE"],"blocked_objects":["symmetry_condition_relation","dominant_domain_projection","executable_semantics"],"dependency_paths":[["OBL-R04-CONGRUENCE","AX-R04_SUBSTITUTION"],["OBL-R04-TYPED-EQUIVALENCE","OBL-R04-CONGRUENCE"]],"priority":"HIGH","evidence":["TYPED_OPERAND_DISTINCTION_SEMANTICS_20260731_001"],"resolution_condition":"Define typed equivalence, then establish relation congruence before permitting nontrivial substitution."})
    ...
    report["delta"]["modified_obligations"] = [{"obligation_id":"OBL-R04-TYPED-EQUIVALENCE","new_status":"UNBLOCKED_PENDING_EQUIVALENCE_DEFINITION"},{"obligation_id":"OBL-R04-CONGRUENCE","new_status":"BLOCKED_BY_OBL-R04-TYPED-EQUIVALENCE"}]
