...
def run(root, output, focus=None):
    ...
    report["object_inventory"]["unresolved"] = [{"object_id": "OBL-RT-IDENTITY-WHOLE", "reason": "open whole-RT identity obligation"}, {"object_id": "OBL-R04-TYPED-EQUIVALENCE", "reason": "canonical equivalence remains undefined; requirements recorded"}, {"object_id": "OBL-R04-CONGRUENCE", "reason": "blocked by unresolved typed equivalence"}] + [{"object_id": axiom, "reason": "open axiom obligation"} for axiom in OPEN_RELATION_AXIOMS]
