...
DISPOSED_RELATION_AXIOMS = RELATION_AXIOMS[:4]
OPEN_RELATION_AXIOMS = RELATION_AXIOMS[4:]
...
def run(root, output, focus=None):
    ...
    report["object_inventory"]["unresolved"] = [{"object_id": "OBL-RT-IDENTITY-WHOLE", "reason": "open whole-RT identity obligation"}] + [{"object_id": axiom, "reason": "open axiom obligation"} for axiom in OPEN_RELATION_AXIOMS]
    report["object_inventory"]["counts"]["unresolved"] = len(OPEN_RELATION_AXIOMS) + 1
    report["proof_state"]["open_obligations"] = ["OBL-RT-IDENTITY-WHOLE"] + OPEN_RELATION_AXIOMS
    ...
    report["delta"]["resolved_obligations"] = [{"obligation_id":"OBL-R04-TYPED-EQUIVALENCE","resolution":"NO_NONTRIVIAL_EQUIVALENCE"},{"obligation_id":"OBL-R04-CONGRUENCE","resolution":"TRIVIAL_REFERENCE_CONGRUENCE_ONLY"},{"axiom_id":"AX-R04_SUBSTITUTION","resolution":"NO_NONTRIVIAL_SUBSTITUTION"}]
