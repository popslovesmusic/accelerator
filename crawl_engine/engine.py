...
DISPOSED_RELATION_AXIOMS = RELATION_AXIOMS[:10]
OPEN_RELATION_AXIOMS = RELATION_AXIOMS[10:]
...
def run(root, output, focus=None):
    ...
    report["object_inventory"]["unresolved"] = [{"object_id": "OBL-RT-IDENTITY-WHOLE", "reason": "open whole-RT identity obligation"}, {"object_id": "OBL-RT-WHOLE-COMPOSITION", "reason": "open whole-RT composition obligation"}, {"object_id": "OBL-SC-OPERAND-PROJECTION", "reason": "open SymmetryCondition operand projection obligation"}, {"object_id": "OBL-R08-CANONICAL-PROJECTION-SELECTION", "reason": "open canonical projection selection obligation"}] + [{"object_id": axiom, "reason": "open axiom obligation"} for axiom in OPEN_RELATION_AXIOMS]
    report["object_inventory"]["counts"]["unresolved"] = len(OPEN_RELATION_AXIOMS) + 4
    report["proof_state"]["open_obligations"] = ["OBL-RT-IDENTITY-WHOLE", "OBL-RT-WHOLE-COMPOSITION", "OBL-SC-OPERAND-PROJECTION", "OBL-R08-CANONICAL-PROJECTION-SELECTION"] + OPEN_RELATION_AXIOMS
    ...
    report["delta"]["resolved_obligations"] = [{"obligation_id":"commutativity_or_noncommutativity","resolution":"INAPPLICABLE"}]
    ...
    report["delta"]["added_axiom_dispositions"] = [{"axiom_id":"AX-R10_COMMUTATIVITY","status":"RESOLVED_INAPPLICABLE"}]
    ...
    report["delta"]["separate_open_obligations"] = ["OBL-RT-IDENTITY-WHOLE", "OBL-RT-WHOLE-COMPOSITION", "OBL-SC-OPERAND-PROJECTION", "OBL-R08-CANONICAL-PROJECTION-SELECTION"]
