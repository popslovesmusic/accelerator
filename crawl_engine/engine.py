...
DISPOSED_RELATION_AXIOMS = RELATION_AXIOMS[:5]
OPEN_RELATION_AXIOMS = RELATION_AXIOMS[5:]
...
def run(root, output, focus=None):
    ...
    report["delta"]["resolved_obligations"] = [{"obligation_id":"composition","resolution":"INAPPLICABLE"}]
    report["delta"]["new_open_obligations"] = ["OBL-RT-WHOLE-COMPOSITION", "OBL-SC-OPERAND-PROJECTION"]
