...
DISPOSED_RELATION_AXIOMS = RELATION_AXIOMS[:9]
OPEN_RELATION_AXIOMS = RELATION_AXIOMS[9:]
...
def run(root, output, focus=None):
    ...
    report["delta"]["resolved_obligations"] = [{"obligation_id":"associativity","resolution":"INAPPLICABLE"}]
    report["delta"]["new_open_obligations"] = []
    report["delta"]["new_associativity_laws"] = []
    report["delta"]["added_axiom_dispositions"] = [{"axiom_id":"AX-R09_ASSOCIATIVITY","status":"RESOLVED_INAPPLICABLE"}]
