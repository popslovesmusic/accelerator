...
This document tracks and categorizes open mathematical questions within the Mono-Process Framework, providing a human-readable counterpart to `registry/math_source_registry.json`.
