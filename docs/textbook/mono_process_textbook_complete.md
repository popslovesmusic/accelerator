...
- **Deviated Constraint Dynamics ($D \to \delta \alpha$):** [ **C1_DEFINED / AWAITING_CAMPAIGN** ] Formalizing the principle that distinction reorganizes admissibility within the same process. Non-Markov and Vortex hypothesis templates design-registered; awaiting simulation campaigns. [Patch: MPF_DEVIATED_CONSTRAINT_DYNAMICS_PATCH_001; Campaigns: MPF_VORTEX_ADMISSIBILITY_CAMPAIGN_001, MPF_NON_MARKOV_ORGANIZATION_TEST_001]
...
- **MPF_VORTEX_ADMISSIBILITY_CAMPAIGN_001:** Investigate whether admissibility updates systematically condition subsequent distinction events (D -> δα feedback loops). [Patch: MPF_DEVIATED_CONSTRAINT_DYNAMICS_PATCH_001]
