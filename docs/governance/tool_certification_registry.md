# Tool rigor endorsement Registry (MPF-ACELL-EQUIV-006)

## 1. Purpose
Define and track the machine-readable rigor endorsement state for all tools in the ecosystem. This registry ensures that tool capability is formally governed and that high-performance engines are not permitted to support scientific claims beyond their proven equivalence level.

## 2. rigor endorsement States
...
- **rigor endorsement_REVOKED**: Tool failed audit and is blocked.
