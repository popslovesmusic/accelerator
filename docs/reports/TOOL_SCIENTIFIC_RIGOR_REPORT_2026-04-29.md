...
| `circular_accelerator_sim_v1_cpp` | accelerator | Verified | C1 |
| `linac_sim_cpp` | accelerator | Verified | C2 |
| `linac_sim_v1` | accelerator | Verified | C1 |
| `agent_based_sim_v1` | agent | Verified | C1 |
| `agent_based_sim_v1_cpp` | agent | Verified | C1 |
| `dase_analog_sim_cpp` | analog_simulation | Verified | C2 |
| `dase_analog_sim_v1` | analog_simulation | Verified | C1 |
| `bifurcation_analyzer_v1` | analyzer | Verified | C1 |
| `bifurcation_analyzer_v1_cpp` | analyzer | Verified | C1 |
| `ca_admissibility_sim_v1` | discrete_ca | Verified | C1 |
| `ca_admissibility_sim_v1_cpp` | discrete_ca | Verified | C1 |
| `falsification_suite_v1` | falsification_harness | Verified | C1 |
| `falsification_suite_v1_cpp` | falsification_harness | Verified | C1 |
| `satp_higgs_3d_sim_cpp` | field_simulation | Verified | C2 |
| `satp_higgs_3d_sim_v1` | field_simulation | Verified | C1 |
| `satp_higgs_sim_cpp` | field_simulation | Verified | C2 |
| `satp_higgs_sim_v1` | field_simulation | Verified | C1 |
| `fsa_rule_engine_sim_v1` | finite_state | Verified | C1 |
| `fsa_rule_engine_sim_v1_cpp` | finite_state | Verified | C1 |
| `symplectic_sim_v1` | hamiltonian | Verified | C1 |
| `symplectic_sim_v1_cpp` | hamiltonian | Verified | C4 |
| `lb_fluid_sim_v1` | lattice_boltzmann | Verified | C1 |
| `lb_fluid_sim_v1_cpp` | lattice_boltzmann | Verified | C1 |
| `graph_dynamics_sim_v1` | network | Verified | C1 |
| `graph_dynamics_sim_v1_cpp` | network | Verified | C1 |
| `kuramoto_sim_v1` | ode_oscillator | Verified | C1 |
| `kuramoto_sim_v1_cpp` | ode_oscillator | Verified | C1 |
| `parameter_optimizer_v1` | optimizer | Verified | C1 |
| `parameter_optimizer_v1_cpp` | optimizer | Verified | C4 |
| `mc_ensemble_sim_v1` | orchestrator | Verified | C1 |
| `mc_ensemble_sim_v1_cpp` | orchestrator | Verified | C4 |
| `rd_moving_boundary_sim_v1` | pde | Verified | C1 |
| `rd_sim_cpp` | pde | Verified | C2 |
| `structural_box_sim_cpp` | pde | Verified | C2 |
| `structural_box_sim_v2` | pde | Verified | C1 |
| `info_metrics_module_v1` | post_processor | Verified | C1 |
| `info_metrics_module_v1_cpp` | post_processor | Verified | C1 |
| `spectral_analysis_v1` | spectral_analyzer | Verified | C1 |
| `spectral_analysis_v1_cpp` | spectral_analyzer | Verified | C4 |
| `stochastic_sim_cpp` | stochastic | Verified | C2 |
| `stochastic_sim_v1` | stochastic | Verified | C1 |
| `tda_module_v1` | topology_analyzer | Verified | C1 |
| `tda_module_v1_cpp` | topology_analyzer | Verified | C4 |
