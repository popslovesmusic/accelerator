...
|---|---|---|---|---|---|---|
| ECON_DEBT_0001 | FOUNDATIONAL | OPEN | CRITICAL | Org_a axioms not formally defined. | formal Sigma_D construction, continuity derivation, recovery derivation | economics_app |
| ECON_DEBT_0002 | FOUNDATIONAL | OPEN | CRITICAL | Sigma_D admissible equivalence criteria undefined. | identity_app, recovery_app, deformation validation | economics_app |
