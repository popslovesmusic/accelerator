...
The attack shall be reproducible from the recorded information alone.
...
A second function inside the same implementation is not considered independent verification.
...
ATTACK_INVALID
: malformed attack, insufficient controls, failed reproducibility, failed independent verification, or incomplete execution.
...
Corrections, reinterpretations, and reformulations shall create new linked records.
...
Evidence generated here may later be inducted into the RT program through its own governance process.

Induction decisions occur outside this repository.
