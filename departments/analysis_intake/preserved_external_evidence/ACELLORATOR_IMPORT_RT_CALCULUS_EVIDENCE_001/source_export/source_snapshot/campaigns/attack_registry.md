...
| **FAT-25-INVARIANT-MINIMALITY** | Invariant Minimality | [03_distinction...md](../chapters/03_distinction_relations_and_directed_difference.md) | [program_m_invariant_minimality.py](campaigns/FAT-25/program_m_invariant_minimality.py) | **Completed** | **Triplet Equivalence Supported** |
| **FAT-26-INVARIANT-DEPENDENCY-GRAPH** | Invariant Dependency Graph | [03_distinction...md](../chapters/03_distinction_relations_and_directed_difference.md) | [program_m_invariant_dependency.py](campaigns/FAT-26/program_m_invariant_dependency.py) | **Completed** | **Whole Expression Primitive Supported** |
...
### FAT-25-INVARIANT-MINIMALITY: Attack on Invariant Minimality

- **Target Concept:** Section 3.2A: Ordering as Structural Information
- **Attack Vector:** Perform Dual Falsification: (1) Program M (Native MTO-OTM) classifies candidate invariants (I1-I8) and tests necessity/sufficiency under structural perturbations, (2) Program S (Standard Mathematics) audits candidate invariants against pointed relational isomorphism and automorphism groups to verify minimality.
- **Python Script:** `campaigns/FAT-25/program_m_invariant_minimality.py`
- **Verification Method:** Compare Program M classification vector and Program S pointed structure minimality verification.
- **Outcome:** **TRIPLET_EQUIVALENCE_SUPPORTED**
- **Findings:** The campaign successfully executed the Dual Falsification Program. Both programs converged on the minimal complete invariant set: {Symmetry Reference, Orientation Roles, Distinction Capacity}. All other proposed invariants (Admissibility, Closure) are derived, or historical (Phase Signature), or represent activity states rather than identity (Coupling). The minimal basis is necessary, sufficient, and complete, validating the target claim.

### FAT-26-INVARIANT-DEPENDENCY-GRAPH: Attack on Invariant Dependency Graph

- **Target Concept:** Section 3.2A: Ordering as Structural Information
- **Attack Vector:** Perform Dual Falsification: (1) Program M (Native MTO-OTM) evaluates dependency edges and construction orders among the minimal invariants, (2) Program S (Standard Mathematics) audits dependency systems (matroids, closure systems) to identify functional and recursive dependencies.
- **Python Script:** `campaigns/FAT-26/program_m_invariant_dependency.py`
- **Verification Method:** Compare Program M dependency classifications and Program S pointed structure generator audit.
- **Outcome:** **WHOLE_EXPRESSION_PRIMITIVE_SUPPORTED**
- **Findings:** The campaign successfully executed the Dual Falsification Program. Both programs converged on the outcome that the complete reference-centered triplet is primitive under closure. The candidate invariants {Symmetry Reference, Orientation Roles, Distinction Capacity} do not exist as independent primitives, but arise only as OTM-exposed aspects of the whole closed relation. Any attempt to decompose the relation to independent binary pairs or separate scalar invariants erases the joint ternary dependency, validating the irreducible whole-expression target claim.
