...
def run_minimal_assumption_preservation_audit():
    registry_path = "registry/math/minimal_assumption_preservation_audit.json"
    result_path = "validation/results/minimal_assumption_preservation_audit_result.json"
    
    report = {
        "validation_id": "VAL-APA-RUN-001",
        "status": "pass",
        "checks_passed": [],
    ...
    # 3. assumption_checks_pass
    checks = registry.get("assumption_audit_checks", [])
...
if __name__ == "__main__":
    res = run_minimal_assumption_preservation_audit()
