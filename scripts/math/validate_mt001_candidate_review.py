...
def validate_mt001_candidate_review():
    registry_path = "registry/math/mt001_projection_idempotence_candidate_review.json"
    result_path = "validation/results/mt001_candidate_review_result.json"
    
    report = {
        "validation_id": "VAL-MT001-REV-VALID-001",
        "status": "pass",
        "checks_passed": [],
    ...
    required_address = ["domain_closure", "admissible_image_membership", "projection_equivalence_definition"]
...
if __name__ == "__main__":
    res = validate_mt001_candidate_review()
