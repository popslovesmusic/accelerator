...
def validate_semantic_deformation():
    registry_path = "registry/math/semantic_deformation_registry.json"
    result_path = "validation/results/semantic_deformation_result.json"
    ...
    # 3. deformation_classes_present
    classes = registry.get("deformation_classes", [])
    required_classes = ["SD_SEQUENTIALIZATION", "SD_FLATTENING", "SD_IDENTITY_INFLATION", "SD_CONFLICT_ERASURE", "SD_ONTOLOGY_DRIFT"]
...
if __name__ == "__main__":
    res = validate_semantic_deformation()
