...
def validate_participatory_interpretation():
    registry_path = "registry/math/participatory_interpretation_registry.json"
    result_path = "validation/results/participatory_interpretation_result.json"
    
    report = {
        "validation_id": "VAL-PI-VALID-001",
        "status": "pass",
        "checks_passed": [],
    ...
    # 3. interpretation_classes_present
    classes = registry.get("interpretation_classes", [])
    required_classes = ["PI_LOCALIZED", "PI_TRACE_DEPENDENT", "PI_CONFLICT_BOUND", "PI_RECURSIVELY_CONSTRAINED", "PI_ACCESSIBILITY_LIMITED"]
...
if __name__ == "__main__":
    res = validate_participatory_interpretation()
