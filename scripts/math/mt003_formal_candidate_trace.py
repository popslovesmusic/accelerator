...
def trace_mt003_readiness(query_id, readiness_reg):
    try:
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Trace MT-003 formal-candidate readiness.")
    ...
    res = trace_mt003_readiness(args.query, args.readiness)
