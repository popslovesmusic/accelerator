...
def validate_mt003_candidate_review():
    registry_path = "registry/math/mt003_nonempty_admissible_image_candidate_review.json"
    result_path = "validation/results/mt003_candidate_review_result.json"
    
    report = {
        "validation_id": "VAL-MT003-REV-VALID-001",
        "status": "pass",
        "checks_passed": [],
    ...
    required_address = ["delta_selection_semantics", "admissible_image_definition", "empty_image_policy"]
...
if __name__ == "__main__":
    res = validate_mt003_candidate_review()
